...
The relevant pages from these volumes have been extracted into the set of PDF files in the [PDFs](PDFs) folder. (Note that the PDFs are too big for GitHub to display - ~10-100 MB - but can be downloaded.)
